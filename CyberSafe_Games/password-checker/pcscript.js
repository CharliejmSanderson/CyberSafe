...
const stopSpeechBtn2 = document.getElementById("stopSpeechBtn2");
...
speakBtn.addEventListener("click", () => {
  speakText(
    "Welcome to Password Checker. Press Start Checking to begin. This game helps you create stronger and safer passwords."
  );
});

speakBtn2.addEventListener("click", () => {
  speakText(
    "Enter a password in the text box. The game will check how strong it is and provide security recommendations."
  );
});

stopSpeechBtn.addEventListener("click", stopSpeech);
stopSpeechBtn2.addEventListener("click", stopSpeech);
